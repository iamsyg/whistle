// // utils/phoneUtils.ts
// // This ensures consistent phone normalization across your entire app
...
//       console.log(`Added country code ${defaultCountryCode} to phone:`, cleaned);
//     }
...
//       console.warn('Invalid E.164 phone length:', cleaned);
//       return null;
//     }
    
//     // Ensure all remaining characters are digits
//     if (!/^\d+$/.test(digits)) {
//       console.warn('Phone contains non-digit characters:', cleaned);
//       return null;
//     }
